...
8. A bank adminstrator should be able to collect fees from existing accounts when necessary.(person 1)
9. A bank adminstrator should be able to add an interest payment to an existing account when necessary. (person 1)
